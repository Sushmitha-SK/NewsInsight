        ...
        <>
            <nav className='navbar'>
                <div className='navbar-container'>
                    <div className='logo'>
                        <a className="navbar-brand logo" onClick={handleNavigation}>News Insight</a>
                    </div>
                    ...
                    <ul className={click ? 'navbar-nav nav-menu active' : 'navbar-nav nav-menu'}>
                        ...
                        <li className='nav-item menu-item'>
                            <Link className="nav-link" onClick={() => handleCategoryClick('world')}>World</Link>
                        </li>
                        <li className='nav-item menu-item'>
                            <Link className="nav-link" onClick={() => handleCategoryClick('nation')}>Nation</Link>
                        </li>
                        <li className='nav-item menu-item'>
